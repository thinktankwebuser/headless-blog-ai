...
function ShareButtonsContent({ slug, title }: ShareButtonsProps) {
...
export default function ClientOnlyShareButtons({ slug, title }: ShareButtonsProps) {
  ...
  return <ShareButtonsContent slug={slug} title={title} />;
}